...
int main(int nargs, char *argv[])
{
    ...
    // add variables so the MPI process declare them
    ...
    // }
        ...
        // create local variables so it only create on window
        // communication of need variables between process
        // pass all the needed variables 
        // deal with conditional for the process
        // register process to run the different variables
        // print on terminal the time in ms to process to have a benchmark of code
        // format code
        ...
        while (myScreen.isOpen())
        {
            if (process == 0)
            {
                ...
                // eventVars calculatedVars;
                // calculatedVars = getEvents(myScreen, animate, advance, dt);

                // advance = calculatedVars.advance;
                // animate = calculatedVars.animate;
                // dt = calculatedVars.dt;
